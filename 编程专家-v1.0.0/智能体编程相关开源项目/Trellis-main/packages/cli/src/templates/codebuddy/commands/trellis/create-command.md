...
Create a new slash command in both `.codebuddy/commands/trellis/` and `.claude/commands/trellis/` directories based on user requirements.
...
- `.codebuddy/commands/trellis/<command-name>.md`
